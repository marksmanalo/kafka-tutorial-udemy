...
public class TwitterProducer {
    ...
    // enter the list of terms you want to follow on twitter
    // these are high volume terms: "bitcoin", "usa", "sport", "soccer"
    List<String> terms = Lists.newArrayList("dealersocket");
    ...
    public void run() {
        ...
        Runtime.getRuntime().addShutdownHook(new Thread( () -> {
            ...
            // we close the producer so that it sends all the messages that it still has in memory to kafka
            // since it is asynchronous it might still have some messages to send over
            producer.close();
            logger.info("done...");
        }));
